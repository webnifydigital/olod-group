...
function AccordionTrigger({
	...
	return (
		<AccordionPrimitive.Header className="flex">
			...
			>
				{children}
				<div className="bg-white rounded-full flex justify-center items-center size-9">
					<ChevronDownIcon className="text-green-dark pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" />
				</div>
			</AccordionPrimitive.Trigger>
